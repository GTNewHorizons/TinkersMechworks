...
public class RedstoneMachineItem extends ItemBlock {
            ...
            if (meta != 1) {
                if (meta == 0 || meta == 3) {
                    ...
                    if (contentTags != null) {
                        ...
                        if (contents != null) {
                            list.add(
                                    StatCollector.translateToLocal("tooltip.drawbridge.inventory") + "\u00a7f"
                                            + contents.getDisplayName());
                            list.add(
                                    StatCollector.translateToLocal("tooltip.drawbridge.amount") + "\u00a7f"
                                            + contents.stackSize);
                        }
                    }
                } else if (meta == 2) {
                    for (int i = 1; i <= 16; i++) {
                        ...
                        if (contents != null) {
                            list.add(
                                    StatCollector.translateToLocal("tooltip.drawbridge.slot") + i
                                            + ": \u00a7f"
                                            + contents.getDisplayName());
                        }
                    }
                ...
                if (camoTag != null) {
                    ...
                    if (camo != null) {
                        list.add(
                                "\u00a72" + StatCollector.translateToLocal("tooltip.drawbridge.camoflauge")
                                        + "\u00a7f"
                                        + camo.getDisplayName());
                    }
                }
    ...
    String getDirectionString(byte key) {
        if (key == 0) return (StatCollector.translateToLocal("tooltip.drawbridge.direction.up"));
        if (key == 1) return (StatCollector.translateToLocal("tooltip.drawbridge.direction.right"));
        if (key == 2) return (StatCollector.translateToLocal("tooltip.drawbridge.direction.down"));
