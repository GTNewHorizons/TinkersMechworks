...
public abstract class MultiblockMasterBaseLogic {
    ...
    public void revisitBlocks() {
        ...
        if (referenceCoord != null
                && this.worldObj.getTileEntity(referenceCoord.x, referenceCoord.y, referenceCoord.z) == null) {
            referenceCoord = null;
        }
        ...
        IMultiblockMember member = (IMultiblockMember) this.worldObj
                .getTileEntity(referenceCoord.x, referenceCoord.y, referenceCoord.z);
