...
public class MultiblockRegistry {
    ...
    public static void onWorldUnloaded(World world) {
        ...
        for (MultiblockMasterBaseLogic master : mastersToRemove) {
            if (master.worldObj.isRemote == world.isRemote
                    && master.worldObj.provider.dimensionId == world.provider.dimensionId) {
    ...
    private static List<IMultiblockMember> getMembersFromListForWorldChunk(
            HashMap<Integer, HashMap<Long, List<IMultiblockMember>>> source, int dimensionId, long chunkCoord) {
    ...
    private static void putMemberInList(HashMap<Integer, HashMap<Long, List<IMultiblockMember>>> destList,
            int dimensionId, long chunkCoord, IMultiblockMember member) {
