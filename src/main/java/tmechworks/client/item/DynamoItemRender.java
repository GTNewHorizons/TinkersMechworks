...
public class DynamoItemRender implements IItemRenderer {
    ...
    public boolean handleRenderType(ItemStack itemStack, ItemRenderType type) {
        if (itemStack == null || itemStack.getItem() != Item.getItemFromBlock(MechContent.dynamo)) return false;
    ...
    public void renderItem(ItemRenderType type, ItemStack itemStack, Object... data) {
        if (itemStack == null || itemStack.getItem() != Item.getItemFromBlock(MechContent.dynamo)) return;
